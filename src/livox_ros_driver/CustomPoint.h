...
struct CustomPoint_ {
  ...
  typedef boost::shared_ptr<
      ...
      Ptr;
  typedef boost::shared_ptr<
      ::livox_ros_driver::CustomPoint_<ContainerAllocator> const>
      ConstPtr;
...
typedef boost::shared_ptr< ::livox_ros_driver::CustomPoint const>
    CustomPointConstPtr;
...
bool operator==(
    const ::livox_ros_driver::CustomPoint_<ContainerAllocator1>& lhs,
...
struct MD5Sum< ::livox_ros_driver::CustomPoint_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::livox_ros_driver::CustomPoint_<ContainerAllocator>&) {
    return value();
  }
