...
class Pinhole_Intrinsic_Brown_T2 : public Pinhole_Intrinsic {
   ...
   public:
     ...
     */
    Pinhole_Intrinsic_Brown_T2(int w = 0, int h = 0, double focal = 0.0, double ppx = 0, double ppy = 0,
     ...
     */
    CAMERA_INTRINSIC getType() const override { return PINHOLE_CAMERA_BROWN; }
     ...
     */
    common::V2D add_disto(const common::V2D &p) const override { return (p + distoFunction(params_, p)); }
    ...
    bool updateFromParams(const std::vector<double> &params) override {
        if (params.size() == 8) {
            *this = Pinhole_Intrinsic_Brown_T2(w_, h_, params[0], params[1], params[2],  // focal, ppx, ppy
   ...
   private:
     ...
     */
    static common::V2D distoFunction(const std::vector<double> &params, const common::V2D &p) {
